...
public:
	...
	static uint16 compute_entry_seed(uint32 key, int entry_index, key_schedule::map_list_type map_list_option);
	...
	static key_schedule_entry compute_entry(uint32 key, int entry_index, key_schedule::map_list_type map_list_option);
