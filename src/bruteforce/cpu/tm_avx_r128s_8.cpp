...
{
	return _calculate_carnival_world_checksum(working_code0, working_code1, working_code2, working_code3, working_code4, working_code5, working_code6, working_code7) == _fetch_carnival_world_checksum_value(working_code0, working_code1, working_code2, working_code3, working_code4, working_code5, working_code6, working_code7);
}
...
{
	return _calculate_other_world_checksum(working_code0, working_code1, working_code2, working_code3, working_code4, working_code5, working_code6, working_code7) == _fetch_other_world_checksum_value(working_code0, working_code1, working_code2, working_code3, working_code4, working_code5, working_code6, working_code7);
}
...
void tm_avx_r128s_8::run_one_map(const key_schedule::key_schedule_entry& schedule_entry)
{
	...
	key_schedule one_map_schedule(0, std::vector<uint8>());
	one_map_schedule.entries.push_back(schedule_entry);

	_run_all_maps(working_code0, working_code1, working_code2, working_code3, working_code4, working_code5, working_code6, working_code7, one_map_schedule, mask_FF, mask_FE, mask_7F, mask_80, mask_01, mask_top_01, mask_top_80);
	_store_to_mem(working_code0, working_code1, working_code2, working_code3, working_code4, working_code5, working_code6, working_code7);
}
...
__forceinline void tm_avx_r128s_8::_run_all_maps(__m128i& working_code0, __m128i& working_code1, __m128i& working_code2, __m128i& working_code3, __m128i& working_code4, __m128i& working_code5, __m128i& working_code6, __m128i& working_code7, const key_schedule& schedule_entries, __m128i& mask_FF, __m128i& mask_FE, __m128i& mask_7F, __m128i& mask_80, __m128i& mask_01, __m128i& mask_top_01, __m128i& mask_top_80)
{
	for (std::vector<key_schedule::key_schedule_entry>::const_iterator it = schedule_entries.entries.begin(); it != schedule_entries.entries.end(); it++)
	{
		...
		for (int i = 0; i < 16; i++)
		{
			// store the current data to memory
			_mm_store_si128((__m128i*)(working_code_data), working_code0);
			_mm_store_si128((__m128i*)(working_code_data + 16), working_code1);
...
__forceinline uint16 tm_avx_r128s_8::fetch_checksum_value(__m128i& working_code0, __m128i& working_code1, __m128i& working_code2, __m128i& working_code3, __m128i& working_code4, __m128i& working_code5, __m128i& working_code6, __m128i& working_code7, uint8 code_length)
{
	_store_to_mem(working_code0, working_code1, working_code2, working_code3, working_code4, working_code5, working_code6, working_code7);
...
uint16 tm_avx_r128s_8::fetch_carnival_world_checksum_value()
{
	...
	return _fetch_carnival_world_checksum_value(working_code0, working_code1, working_code2, working_code3, working_code4, working_code5, working_code6, working_code7);
}
...
uint16 tm_avx_r128s_8::fetch_other_world_checksum_value()
{
	...
	return _fetch_other_world_checksum_value(working_code0, working_code1, working_code2, working_code3, working_code4, working_code5, working_code6, working_code7);
}

__forceinline uint16 tm_avx_r128s_8::_fetch_carnival_world_checksum_value(__m128i& working_code0, __m128i& working_code1, __m128i& working_code2, __m128i& working_code3, __m128i& working_code4, __m128i& working_code5, __m128i& working_code6, __m128i& working_code7)
{
	return fetch_checksum_value(working_code0, working_code1, working_code2, working_code3, working_code4, working_code5, working_code6, working_code7, CARNIVAL_WORLD_CODE_LENGTH - 2);
}

__forceinline uint16 tm_avx_r128s_8::_fetch_other_world_checksum_value(__m128i& working_code0, __m128i& working_code1, __m128i& working_code2, __m128i& working_code3, __m128i& working_code4, __m128i& working_code5, __m128i& working_code6, __m128i& working_code7)
{
	return fetch_checksum_value(working_code0, working_code1, working_code2, working_code3, working_code4, working_code5, working_code6, working_code7, OTHER_WORLD_CODE_LENGTH - 2);
}
...
void tm_avx_r128s_8::run_first_map(uint32 key, uint32 data, const key_schedule& schedule_entries)
{
	__m128i working_code0;
	__m128i working_code1;
	__m128i working_code2;
