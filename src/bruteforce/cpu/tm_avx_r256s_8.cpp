...
void tm_avx_r256s_8::run_one_map(const key_schedule::key_schedule_entry& schedule_entry)
{
	...
	_run_all_maps(working_code0, working_code1, working_code2, working_code3, one_map_schedule, mask_FF, mask_FE, mask_7F, mask_80, mask_01, mask_top_01, mask_top_80);
